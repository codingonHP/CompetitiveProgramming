...
//namespace CompetitiveProgramming.Unsolved
//{
//    /// <summary>
//    /// Solution class
//    /// </summary>
//    public static class TreeUnsolved
//    {
//        #region Main
...
//            long s = Console.NextInt(true);
//            long q = Console.NextInt(true);


//            var elements = GetOrderedElement(level, s);
//            var tree = Tree.CreateTree(elements);

//            for (int i = 0; i < q; i++)
//            {
//                int qtype = Console.NextInt();
//                long valK = Console.NextInt(true);

//                Solve(tree, qtype, valK);
//            }
//        }
...
//        private static long[] GetOrderedElement(long levels, long sum)
//        {
//            //int[] arry = new[] { 3, 2, 4, 2, 3, 4, 5 };
//            long[] arry = new long[(int)Math.Pow(2, levels) - 1];
//            return arry;
//        }

//        private static void Solve(Tree tree, int qtype, long valk)
//        {
//            if (qtype == 0)
//            {
//                Console.WriteLine(tree.GetPathTo(valk));
//            }
//            else
//            {
//                Console.WriteLine(tree.ValueArry[valk - 1]);
//            }
//        }
...
//            public long[] ValueArry { get; private set; }

//            private Node Root { get; set; }

//            private Tree() { }
//            public static Tree CreateTree(long[] values)
//            {

//                Tree tree = new Tree { ValueArry = values };
...
//            public string GetPathTo(long value)
//            {
//                StringBuilder sb = new StringBuilder();
//                Traverse(Root, value, sb);
//                return sb.ToString();
//            }

//            private void Traverse(Node node, long value, StringBuilder sb)
//            {
//                if (node == null)
//                {
//                    return;
...
//                {
//                    sb.Append("l");
//                    Traverse(node.LeftTree, value, sb);
//                }
//                else if (value > node.Value)
//                {
//                    sb.Append("r");
//                    Traverse(node.RightTree, value, sb);
//                }
//            }

//            private void AddNode(long value)
//            {
//                if (Root == null)
//                {
//                    InitTree(value);
...
//            private void AppendNode(Node node, long value)
//            {
//                if (node == null)
//                {
//                    return;
...
//                if (node.LeftTree == null && value <= node.Value)
//                {
//                    Node newNode = new Node(value);
//                    node.LeftTree = newNode;
//                }
//                else if (node.RightTree == null && value > node.Value)
//                {
//                    Node newNode = new Node(value);
...
//                else if (value > node.Value)
//                {
//                    AppendNode(node.RightTree, value);
//                }
//                else
//                {
//                    AppendNode(node.LeftTree, value);
//                }
//            }

//            private void InitTree(long value)
//            {
//                Root = new Node(value);
//            }
...
//    #region Fields
//    private readonly BufferedStream _inStream; // Buffered console input stream
//    private readonly StreamWriter _outStream; // Buffered console output stream

//    private readonly byte[] _inBuffer; // Input buffer 
//    private int _inputIndex; // Input buffer current index
//    private int _bufferEnd; // Input buffer ending index
//    #endregion
...
//    public void Skip(int n = 1) => this._inputIndex += n;
...
//    public void Write(char c) => this._outStream.Write(c);

//    /// <summary>
//    /// Writes the given char buffer to the console output
//    /// </summary>
//    /// <param name="buffer">Char buffer to write</param>
//    public void Write(char[] buffer) => this._outStream.Write(buffer);

//    /// <summary>
//    /// Writes the given string to the console output
//    /// </summary>
//    /// <param name="s">String to write</param>
//    public void Write(string s) => this._outStream.Write(s);
...
//    public void Write(StringBuilder sb) => this._outStream.Write(sb.ToCharArray());

//    /// <summary>
//    /// Writes the given object to the console output using the object's ToString method
//    /// </summary>
//    /// <param name="o">Object to write</param>
//    public void Write(object o) => this._outStream.Write(o);
...
//    public void Write<T>(IEnumerable<T> e, string separator = "") => this._outStream.Write(new StringBuilder().AppendJoin(e, separator).ToCharArray());
...
//    public void Write<T>(IEnumerable<T> e, char separator) => this._outStream.Write(new StringBuilder().AppendJoin(e, separator).ToCharArray());

//    /// <summary>
//    /// Writes a linefeed to the console output
//    /// </summary>
//    public void WriteLine() => this._outStream.WriteLine();

//    /// <summary>
//    /// Writes the given char to the console output, followed by a linefeed
//    /// </summary>
//    /// <param name="c">Character to write</param>
//    public void WriteLine(char c) => this._outStream.WriteLine(c);
...
//    public void WriteLine(char[] buffer) => this._outStream.WriteLine(buffer);

//    /// <summary>
//    /// Writes the given string to the console output, followed by a linefeed
//    /// </summary>
//    /// <param name="s">String to write</param>
//    public void WriteLine(string s) => this._outStream.WriteLine(s);
...
//    /// </summary>
//    /// <param name="sb">StringBuilder to write to the output</param>
//    public void WriteLine(StringBuilder sb) => this._outStream.WriteLine(sb.ToCharArray());
...
//    /// <param name="e">Sequence to print</param>
//    /// <param name="separator">String separator between each element, defaults to the empty string</param>
//    public void WriteLine<T>(IEnumerable<T> e, string separator = "") => this._outStream.WriteLine(new StringBuilder().AppendJoin(e, separator).ToCharArray());
...
//    /// <param name="e">Sequence to print</param>
//    /// <param name="separator">Character separator between each element</param>
//    public void WriteLine<T>(IEnumerable<T> e, char separator) => this._outStream.WriteLine(new StringBuilder().AppendJoin(e, separator).ToCharArray());

//    /// <summary>
//    /// Writes the given object to the console output using the object's ToString method, followed by a linefeed
//    /// </summary>
//    /// <param name="o">Object to write</param>
//    public void WriteLine(object o) => this._outStream.WriteLine(o);

//    /// <summary>
//    /// Flushes the output buffer to the console if the buffer is full, or if it's being forced
//    /// </summary>
//    public void Flush() => this._outStream.Flush();
