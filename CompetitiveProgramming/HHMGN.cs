...
namespace CpForHHMGN
{
    public static class HHMGN
    {
        #region Main
        ...
        private static void TestCases()
        {
            try
            {
                ...
                for (int i = 0; i < tc; i++)
                {
                    ...
                    var arry = Console.NextLongs((int)n);

                    var number = GetNumber(arry, k);
        ...
        public static long GetNumber(long[] arry, long k)
        {
            try
            {
                ...
                {
                    var sum = (arry.Length - i) * arry[i] + prevSum;
