...
namespace CpForCompetitiveProgrammingMAXOR
{
    public static class MAXOR
    {
        #region Main
        ...
        private static void TestCases()
        {
            ...
            for (int i = 0; i < tc; i++)
            {
                ...
                var numbers = Console.NextInts(n);
                var output = Solve(numbers);
        ...
        public static int Solve(int[] numbers)
        {
            ...
            numbers = numbers.OrderByDescending(e => e).ToArray();
            ...
            for (int i = 0; i < numbers.Length; i++)
            {
                ...
                {
                    if (i < j && (numbers[i] | numbers[j]) <= Math.Max(numbers[i], numbers[j]))
                    {
                        ++count;
                    }
                }
