...
namespace CpForCOMPCLUB
{
    public static class COMPCLUB
    {
        #region Main
        ...
        class Node
        {
            public readonly Dictionary<char, Node> List = new Dictionary<char, Node>();
            public readonly long ChildrenCount;
            private readonly bool LastNode = false;
