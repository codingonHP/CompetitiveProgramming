...
namespace CompetitiveProgrammingTWONMS
{
    public static class TWONMS
    {
        #region Main
        ...
        private static void TestCases()
        {
            ...
            for (int i = 0; i < tc; ++i)
            {
                ...
                int t = Console.NextInt(true);

                var iq = GetIntegerQuotient(a, b, t);

                Console.WriteLine(iq);
            }
        }

        private static long GetIntegerQuotient(int a, int b, int t)
        {
            long alice = a;
            long bob = b;
