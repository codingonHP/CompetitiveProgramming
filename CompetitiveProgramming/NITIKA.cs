...
namespace CpForNITIKA
{
    public static class NITIKA
    {
        #region Main
        ...
        public static string Solve(string name)
        {
            ...
            if (parts.Length == 1)
            {
                var n = parts[0];
                n = n.ToLower();
                var nameArry = n.ToCharArray();
                nameArry[0] = (char)(nameArry[0] - 32);

                return new string(nameArry);
            }
            ...
            if (parts.Length > 2)
            {
                ...
                sb = new StringBuilder(new string(nameArry));
                sb.Insert(0, parts[0][0].ToString().ToUpper());
                sb.Insert(1, '.');
                sb.Insert(2, ' ');

                sb.Insert(3, parts[1][0].ToString().ToUpper());
                sb.Insert(4, '.');
                sb.Insert(5, ' ');
            }
            else
